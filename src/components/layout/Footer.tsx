    ...
    <footer className="bg-black text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row md:justify-between gap-8">
          {/* Left - Logo & Info - Left aligned */}
          <div className="flex flex-col gap-3">
            <div className="relative -left-5 w-30 h-30">
              <Image
                src="/logo.png"
                alt="Chigomezyo PVT Primary School Logo"
                fill
          ...
          <div className="flex flex-col gap-6">
            {/* Social Icons - White bg, blue icons, left-aligned on mobile */}
            <div className="flex gap-4 justify-start md:justify-end md:mr-8">
              {/* WhatsApp */}
              <a
                href="https://wa.me/265881829772"
                target="_blank"
            ...
            <div className="grid grid-cols-2 gap-2 text-gray-300 text-sm md:text-base">
              ...
              <Link href="/admissions" className="hover:text-blue-500 transition">Admissions</Link>
