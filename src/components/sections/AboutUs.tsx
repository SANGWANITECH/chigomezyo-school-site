    ...
    <section className="bg-white py-12 md:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-end mt-10">
          <a
            href="#"
            className="inline-flex items-center border-2 border-black/50 text-black font-semibold text-base md:text-lg px-6 py-3 rounded-xl hover:bg-gray-50 transition"
          >
            See More →
          </a>
        </div>
