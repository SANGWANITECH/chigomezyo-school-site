"use client";  // ← THIS LINE IS REQUIRED FOR YOUR PROJECT
  ...
  const reasons = [
    {
      ...
      desc: "Our students consistently achieve outstanding PMSCE results, with a 98% pass rate and top rankings in Malawi.",
    },
    {
      icon: FaUsers,
    ...
    <section className="w-full py-12 md:py-20 text-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 md:mb-8">
          Why <span className="inline-block bg-yellow-300/30 text-yellow-800 px-2 py-1 rounded-lg">Chigomezyo?</span>
        </h2>

        {/* Subtitle */}
        <p className=" md:text-lg lg:text-xl text-gray-900 max-w-3xl mx-auto mb-12 md:mb-16">
          Discover why Chigomezyo Private primary School is the ideal choice for your child's education and future success.
        </p>
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 max-w-5xl mx-auto">
          {reasons.map((reason, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative bg-white border-gray-300 rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden group animate-zoomInDelay"
              ...
              >
                ...
                <div className="p-6 md:p-8 text-center">
                  ...
                  <div className="mb-4 md:mb-6 flex justify-center">
                    <Icon className="text-blue-900/90 text-4xl md:text-5xl animate-slow-pulse" />
                  </div>
